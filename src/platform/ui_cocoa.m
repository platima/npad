/*
 * npad - Cocoa UI Implementation (Stub)
 * macOS Cocoa-specific UI implementation
 *
 * Author: Platima
 * https://github.com/platima/npad
 *
 * TODO: Implement Cocoa backend
 */
...
// This allows the project to build for macOS while Cocoa implementation is pending

bool ui_platform_init(void) {
    printf("Cocoa UI implementation not yet available\n");
    return false;
}
