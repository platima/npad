/*
 * npad - Wayland UI Implementation (Stub)
 * Linux/Unix Wayland-specific UI implementation
 *
 * Author: Platima
 * https://github.com/platima/npad
 *
 * TODO: Implement Wayland backend
 */
...
// This allows the project to build for Linux while Wayland implementation is pending

bool ui_platform_init(void) {
    printf("Wayland UI implementation not yet available\n");
    return false;
}
