...
#define NPAD_ERROR_INFO(category, code, context, ...) \
    npad_error_report(NPAD_ERROR_INFO, category, code, __FILE__, __LINE__, __func__, context, __VA_ARGS__)

#define NPAD_ERROR_WARNING(category, code, context, ...) \
    npad_error_report(NPAD_ERROR_WARNING, category, code, __FILE__, __LINE__, __func__, context, __VA_ARGS__)

#define NPAD_ERROR_ERROR(category, code, context, ...) \
    npad_error_report(NPAD_ERROR_ERROR, category, code, __FILE__, __LINE__, __func__, context, __VA_ARGS__)

#define NPAD_ERROR_FATAL(category, code, context, ...) \
    npad_error_report(NPAD_ERROR_FATAL, category, code, __FILE__, __LINE__, __func__, context, __VA_ARGS__)
...
#define NPAD_ERROR_FILE_IO(operation, filename) \
    NPAD_ERROR_ERROR(NPAD_ERROR_FILE_IO, errno, filename, "File %s failed: %s", operation, strerror(errno))
