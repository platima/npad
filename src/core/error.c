...
void npad_error_report(npad_error_level_t level, npad_error_category_t category,
    ...
    // Copy context
    snprintf(g_last_error.context, sizeof(g_last_error.context), "%.255s", 
             context ? context : "");
...
bool npad_error_has_error(void) {
    if (!g_error_initialized) return false;
...
const char *npad_error_level_to_string(npad_error_level_t level) {
    switch (level) {
        case NPAD_ERROR_INFO:    return "INFO";
        case NPAD_ERROR_WARNING: return "WARN";
        case NPAD_ERROR_ERROR:   return "ERROR";
        case NPAD_ERROR_FATAL:   return "FATAL";
...
const char *npad_error_category_to_string(npad_error_category_t category) {
    switch (category) {
        case NPAD_ERROR_NONE:          return "NONE";
        case NPAD_ERROR_MEMORY:        return "MEMORY";
        case NPAD_ERROR_FILE_IO:       return "FILE_IO";
        case NPAD_ERROR_NETWORK:       return "NETWORK";
        case NPAD_ERROR_INVALID_PARAM: return "INVALID_PARAM";
        case NPAD_ERROR_SYSTEM:        return "SYSTEM";
        case NPAD_ERROR_UI:            return "UI";
        case NPAD_ERROR_EDITOR:        return "EDITOR";
        case NPAD_ERROR_SETTINGS:     return "SETTINGS";
        case NPAD_ERROR_THREAD:        return "THREAD";
        case NPAD_ERROR_UNKNOWN:       return "UNKNOWN";
